...
<footer class="bg-light text-dark mt-5 py-4">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    @if (Auth::check())
                        <li><a href="/dashboard" class="text-dark text-decoration-none">Dashboard</a></li>
                        <li><a href="/session/logout" class="text-dark text-decoration-none">Logout</a></li>
                    @else
                        <li><a href="/session" class="text-dark text-decoration-none">Login</a></li>
                    @endif
                </ul>
            </div>
        ...
        <div class="text-center">
            <p class="mb-0">&copy; {{ date('Y') }} Ghazian. Semua Hak Dilindungi.</p>
        </div>
    </div>
</footer>
